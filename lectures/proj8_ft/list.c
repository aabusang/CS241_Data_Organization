/***********************
 *This file has all the functions used 
 *for this project except main
 ********************/
...
/*****************************
 * struct Patient p, struct out                                                                                                             * This function does not return any value (void)                                                                                           * This function stores patient data in the file, it also calls the showTime function                                                       *****************************************************************************/
...
/************
 * Queue queue                                                                                                                              * This function does not return any value (void)                                                                                           * This function  prints patients in the Queue, (function for debugging)
 ****************************************************************************/
 ...
 * Queue queue
 *This function does not return any value (void)
 *This funtion prints all patients using showPatientData function
***********************************************************************/
 ...
 * Queue queue
 * This function does not return anything (void)
 * This function  updates the time for all the
 *patients in the ready Queue. It call updateTime function
 **************************************************************/
 ...
 * This function does not return anything (void)
 * This function removes the patient from the ready Queue. I
 *t is called in the getNext function.
 *****************************/
...
void dischargePatient(Queue* queue,Patient* patient)
{
    ...
    {
	/* move end to backward*/
	queue->end = prev;
	/* assign NULL to next of this*/
	prev->next = NULL;
    }
    else if(cursor != NULL)
    {
...
Patient* getNext(Queue* queue)
{
    ...
    /* remove the patient from the ready queue*/
