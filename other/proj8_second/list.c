/****************
 *list.c contains the implemenation of all the function 
 * Declared in header.h and used in main
 *********************************************/
#include "header.h"
 ...
 * This function stores patient data in the file,  
 * it also calls the showTime function
 ***********************************/
...
/************ 
 * Queue queueThis function does not return any value (void)
 ...
 * Queue queue
 * This function does not return anything (void)
 * This function  updates the time for all the patients in the ready Queue.
 * It call updateTime function
 ***************************************************************************/
 ...
 * This function does not return anything (void)
 * This function removes the patient from the ready Queue. 
 * It is called in the getNext function. 
 ************************************************************/
...
/*********************************************
 * File out, Queue source, constant int no_patients
 * This function does not return anything (void)
